              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tr v-for="item in lists" :key="item.id">
                    ...
                    <td>{{ item.konsumsianggaran }}</td>
                    <td>{{ item.sisaanggaran }}</td>                    <td>
                        <a
                            href="#"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <input
                                type="text"
                                v-model="form.konsumsianggaran"
                                class="form-control"
                                :class="{
                                    'is-invalid': form.errors.has('konsumsianggaran')
                                }"
                            />
                            <has-error
                                :form="form"
                                field="konsumsianggaran"
                            ></has-error>
                        </div>
                        <div class="form-group">
                            <input
                                type="text"
                                v-model="form.sisaanggaran"
                                class="form-control"
                                :class="{
                                    'is-invalid': form.errors.has('sisaanggaran')
                                }"
                            />
                            <has-error
                                :form="form"
...
export default {
  ...
  methods: {
    ...
    loadData() {
      this.$Progress.start();
      axios
      .get("api/ambildatamaster")
      .then(({ data }) => (this.masters = data));
      axios.get("api/listAnggaran").then(({ data }) => (this.lists = data));
    ...
    simpanData() {
        ...
        ubahData() {
            ...
            this.disabled = true;
            this.form
                .put("api/listAnggaran/" + this.form.id)
                .then(() => {
                    Fire.$emit("refreshData");
                    $("#modalmuncul").modal("hide");
                    Toast.fire({
